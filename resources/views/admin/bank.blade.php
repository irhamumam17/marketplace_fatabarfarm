    ...
    <div class="modal-dialog modal-lg" id="modal">
        <div class="modal-content">
            <div class="modal-header ">
                <h4 class="modal-title" v-show="!editMode" id="myLargeModalLabel">Tambah Data Bank</h4>
                <h4 class="modal-title" v-show="editMode" id="myLargeModalLabel">Edit Data Bank</h4>
            ...
            <form @submit.prevent="editMode ? updateData() : storeData()" @keydown="form.onKeydown($event)" id="form">
                <div class="modal-body mx-4">
                    <div class="form-row">
                        <label class="col-lg-2" for="Nama">Nama Bank</label>
                        <div class="form-group col-md-8">
                            <input v-model="form.name" id="name" type="text" min=0 placeholder="Masukkan Nama Bank"
                                class="form-control" :class="{ 'is-invalid': form.errors.has('name') }">
                            <div v-if="form.errors.has('name')" v-html="form.errors.get('name')" ></div>
                        </div>
                    </div>
                    <div class="form-row">
                        <label class="col-lg-2" for="account_number">Nomor Rekening</label>
                        <div class="form-group col-md-8">
                            <input v-model="form.account_number" id="account_number" type="text" min=0 placeholder="Masukkan Nomor Rekening"
                                class="form-control" :class="{ 'is-invalid': form.errors.has('account_number') }">
                            <div v-if="form.errors.has('account_number')" v-html="form.errors.get('account_number')" ></div>
                        </div>
                    </div>
                </div>
        ...
        methods: {
          ...
          clearForm(){
            ...
            storeData() {
                ...
                this.form.post("{{ route('bank.store') }}")
                    .then(response => {
            ...
            updateData() {
                ...
                url = "{{ route('bank.update', ':id') }}".replace(':id', this.form.id)
                this.form.put(url)
                .then(response => {
                    if(response.data.success == true){
                        Swal.fire(
            ...
            deleteData(id) {
                Swal.fire({
                    title: 'Apakah Anda Yakin Menghapus Bank Ini?',
