...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form @submit.prevent="editData()" @keydown="form.onKeydown($event)" id="form">
        ...
        var app = new Vue({
            ...
            data: {
              ...
              form: new Form({
                ...
                preview: imgUrl+'/storage/'+data.file.path,
            },
            created(){
            ...
            methods: {
                ...
                async editData(){
                    ...
                    url = "{{ route('product.varian.update', ':id') }}".replace(':id', this.form.uuid)
                     await this.form.post(url).then(response => {
