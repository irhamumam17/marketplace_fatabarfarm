...
<div class="card">
    ...
    <div class="card-body">
        ...
        {{-- <form method="POST" action="{{ route('blog.store') }}" enctype="multipart/form-data"> --}}
            ...
            <div class="modal-body mx-4">
                ...
                <div class="form-row">
                    <label class="col-lg-2" for="content">Konten</label>
                    <div class="form-group col-md-8">
                        <textarea name="content" id="content" placeholder="Masukkan content Produk"
                            class="form-control" ></textarea>
                        {{-- <div v-if="form.errors.has('content')" v-html="form.errors.get('content')"></div> --}}
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <div id="preview">
                                <img v-if="preview" :src="preview" style="margin-top: 20px;"/>
                            </div>
                        @if ($errors->has('image'))
    ...
    let app = new Vue({
        ...
        mounted(){
            ...
            $('#content').summernote('code',this.form.content);
        ...
        methods: {
            async updateData(){
                ...
                this.form.content = $('#content').summernote('code')
                url = "{{ route('blog.update', ':id') }}".replace(':id', this.form.uuid)
