                            ...
                            <div class="ah-lg-mode">
                                ...
                                <ul class="ah-list ah-list--design2 ah-list--link-color-secondary">
                                    <li>
                                        ...
                                        <a href="shop-side-version-2.html">HOME</a></li>
                                                    ...
                                                    <div class="mini-product">
                                                        <div class="mini-product__image-wrapper">
                                                            ...
                                                            <a class="mini-product__link" href="product-detail.html">
                                                                ...
                                                                <img class="u-img-fluid" src="{{ asset('landing_assets/images/product/electronic/product3.jpg')}}" alt=""></a></div>
                                                    ...
                                                    <div class="mini-product">
                                                        <div class="mini-product__image-wrapper">
                                                            ...
                                                            <a class="mini-product__link" href="product-detail.html">
                                                                ...
                                                                <img class="u-img-fluid" src="{{ asset('landing_assets/images/product/electronic/product18.jpg')}}" alt=""></a></div>
                                                        <div class="mini-product__info-wrapper">
                                                    ...
                                                    <div class="mini-product">
                                                        <div class="mini-product__image-wrapper">
                                                            ...
                                                            <a class="mini-product__link" href="product-detail.html">
                                                                ...
                                                                <img class="u-img-fluid" src="{{ asset('landing_assets/images/product/women/product8.jpg')}}" alt=""></a></div>
                                                        <div class="mini-product__info-wrapper">
                                                    ...
                                                    <div class="mini-product">
                                                        <div class="mini-product__image-wrapper">
                                                            ...
                                                            <a class="mini-product__link" href="product-detail.html">
                                                                ...
                                                                <img class="u-img-fluid" src="{{ asset('landing_assets/images/product/men/product8.jpg')}}" alt=""></a></div>
                                                        <div class="mini-product__info-wrapper">
